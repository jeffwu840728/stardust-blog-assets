/* ============================================================
   ★ EXO STARDUST 槍火重生英雄資料庫 (Hero Database) ★
   ============================================================ */
window.STARDUST_ASSETS = window.STARDUST_ASSETS || {};
window.STARDUST_ASSETS.gunfire = window.STARDUST_ASSETS.gunfire || {};
window.STARDUST_ASSETS.gunfire.Heroes = {
  桃: {
    Role: {
      桃: {
  ...
  紫鴞: {
    ...
    blessings: {
      星海羅盤: {
        ...
        desc: "SYS_LOG: 星落的最終傷害提高200%，使用次仙次數+1。受背包秘卷影響，有機率會使星落的【陣圖】品質提升1級。【傳說陣圖】的星落提升1級將獲得額外效果：星落每對單個目標造成0.75秒持續傷害時，對其3.5公尺範圍內的敵人造成2400點傷害。",
      },
      爆裂手牌: {
  ...
  凜: {
    ...
    talents: {
      ...
      寒脈淬體: {
        ...
        desc: "每有1%的傷害抗性，則武器 and 技能傷害增加1%；每有-1%的傷害抗性，則武器和技能傷害增加2%。",
      },
      化雪凝冰: {
    ...
    blessings: {
      ...
      冰破殘響: {
        ...
        desc: "SYS_LOG: 霜凍手榴彈爆炸時有100%的機率隨機擊碎範圍內的1個“破綻”並造成額外爆炸。每額外爆炸1次，觸發機率、傷害 and 爆炸範圍減半。",
      },
      嚴寒沁髓: {
  ...
  墨咻: {
    ...
    skills: {
      靈墨化形: {
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjFU7rh8RXHSw1EAgR2Q799ROVxFlD0DoNfsynxJTK-B6yVvBhEBlJj1EXPi6vgJ0AvtemV6DkaD6EdXOZ-ZeXBT1iQJ7V6yIvTSLBNlB2IaVWjYBcjpTSZbLz7xG8M2Nl6QE5cV5gy_PPoK6BXB-DGW-kV6w5soTOqQKsyU9_P4ul90lLbPiD1lNnoF0c/s95/Gunfire_Reborn_oKFZqjvAty-removebg-preview.webp",
        desc: "化身墨靈，持續16秒。此時場內會生成2顆墨珠，拾取後可增加10點“墨韻”。可消耗15點“墨韻”釋放【墨鋒四散】，對自身周圍5公尺範圍的所有敵人造成450點濁墨傷害。",
      },
      揮墨成卷: {
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiLekIDaoeKxY1SM2Zsg9CW1CfIr_V0NBKwUtRTXF2VMUyPqx9VpJFTGqufbbzSP8SguYZF69QJfk6tujIIYzij1ohkzs_o8ajLrNCWfywwuaoKXJt7JDzLn4Hmbn-cf-4x2_Qle2nwlNp4QUkCxIg3E6xCHtnG_rQ32qX4bCrlhyphenhyphenR-sC1Xodq49gKDyUg/s95/Gunfire_Reborn_eNtIjSg2sC-removebg-preview.webp",
    ...
    ascensions: {
      ...
      墨潮奔湧: {
        branch: 1,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiwJHF3LvQMqRTtOgeDRiLRuRNceYhi77pUpHjoLqGWyXONx1EDgx_W0oEQLWpp3oD2rwJRR3pPEvX6mWVcJrE6cl3CWO7N3bf8nhFpFQ6t5ety04uvXTppkmzHmpOlgqjvPz7xTvFaMt-2OwsuMnclSun-yI3dL2IdWE5Wviv04taFT788gDJAW3usz10/s64/Surge_Ink.webp",
        desc: "大幅提升濁墨基礎傷害。",
      },
      蝕墨殘痕: {
        branch: 1,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhD6AAUThD_36IhCDxrHaPFVu_kkg_uLAqQjIl9C8Y7BCWf2FBhiF5dHi4H4Aur9OrPQQcmM3DRccdndODMeOCIB8_dtqOqwm16H3xSDKh_ev6xDhR3AbLhWXtDu-NWqrwa-SDVZBXveSjIfQb7ReA2oXcOp8XOp41mU5FFqN6DDlfg6ECawyduwKyq8Zk/s64/Residual_Traces.webp",
        desc: "附帶濁墨持續傷害。",
      },
      斑斕濁色: {
        branch: 1,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh-x2F1K2NTgv_8G6_No0SlJCeQH1eSxejoLPkkXtbS4awiw2BY_gsdhabw6e9ATuHS6TX4qNlvfVvhQa-L5G9Z34JfPlCtszP14W_zdxxF-usOxfq6Q5Gn3KB98_7s8cODEH_f5If-34NSWxH32S-Yn9b65EVQ8lFSVAZjYhVpI6tAC89h-xB0yprBzmQ/s64/Colorful_Black.webp",
        desc: "拾珠增傷與化形減傷。",
      },
      墨域擴張: {
        branch: 1,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi0V8E0pQaXSF4zH-vO_a7OOKGjiwzvWmaNeyT33FqY7QQ3uaO05SougCuEbnsXa-LZna9GPGfYUF3J8HX5_cDl_vqjAfi7nUufYugy39esctP4O1E0EuWiR9YGvM6cDx0AB4nJRlH8v3kIM_9i7PUBPquL_YVfaOxJ_QA7Sfw501kw1pN7S2yUB3YqHF4/s64/Domain_Expansion.webp",
        desc: "擴大範圍與濁墨增傷。",
      },
      珠連墨續: {
        branch: 1,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgeMtqxqR1wg_56YUkwxhjlIpn_C-fO7v4G2o7bbqCBtKiZlde1W_ldqjoD4xqF6lgYLU8guhrmKvgLqUAwr8F9Oxif1h0FJpcjbsfS93hGlxL3icHzwfJO2KNtIZyMmN3PT-FoEUxanN-atP0M53yeOPQ6NJxSCF-7BB4VX7s1O6vXt_AhSrpHeON4nTU/s64/Continuous_Design.webp",
        desc: "延長化形與增加墨珠。",
      },
      乾坤墨移: {
        branch: 1,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgy-KM2mF_S7VvBRr0x1_6GqHn_dOhOrz6AmlG95MnKEZn6dSrwIN9sMRn53qaKFZ7foBXbFkdPGEsjS9VvP1g12sBcJMWk-W_cjhbAjwBrErd7aBFzbbkaeb5xPeROMtU2mETaY3oBgFRPbEaXmVKXDi1CKiS0KTbn6L5SP7LRgbRUUsNOeTdETSaac24/s64/Ink_and_Blank%252C_Yin_and_Yang.webp",
        desc: "濁域變清域並大幅增傷。",
      },
      //覺醒分支二
      筆力遒勁: {
        branch: 2,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhET-_W7xsthl_CKd0h2BNIZ8s_L2PuTTBJgKjvOANMhxGwkbTeg9mQ7n6b5ajVFU2Ijzq3GvrX9zhmFV-s5NrfnmnwuHaZOvy1xWfXy4zeJW7LBuO3nNBENFNmxEMWung2fzS4gp4Z1jk_DJSGcNj8SFF6Ww0xMZWXhKhsWjEnqRc5zndJ6OnKHBghzNU/s64/Sharp_Penmanship.webp",
        desc: "提升墨卷傷害與推進。",
      },
      聚墨齊揮: {
        branch: 2,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgmEUl7f_FV6dXuVo6SKk7wCscU_fDrdrHVID5IF0ls1BV5WqW06GuJ_b-ASnNZ7cD8iKS5_IrI3kpIc9EDWqLEthdCuxkvoi_st2sNiiCob2aKj8rG4mbeD2Z2CKJ6zPe8ErFZIFFPwSzWhuyCaXR69zqLpWBZp8uGAXYboRfBxqauiilitiYNRQuzV38/s64/Ink_Flow.webp",
        desc: "依清域面積大幅增傷",
      },
      墨幕鋪陳: {
        branch: 2,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh63SvqXFEOFgypZuet9iFWI_bZPO6SVjJ5Jdaey_UbmB_G8TxAKuoZehk0qR6HJo7IL2uUkUwhcxbT1wtKiDe17a8JCKrFsvzU5_nMvJLbVkOxJH-hiKH3qTSWIH8yBlNAVXdHsTkmFzDb1xXCX9DwnwIeHM1I8EJ1L7V4vwmMCPtFYn2rI-1JA9JO8oc/s64/Ink_Curtain.webp",
        desc: "墨卷變大並獲得墨韻。",
      },
      墨蹟再生: {
        branch: 2,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiZSxxNUoIOz3v0ZuMNPa3swabRBD6GSLuPV_tBKDiemA0tWH3XEgUrfBROaSFEu1T1myql7yCLl3bjxOmFUsRFDHZrbnshcm6OPr4K3Cd1Bey1B0NEjYX-AqIlO4uH1eoF5KZNeNeZdwtlQhrpBOJ2VKpnFAaG5qvcRfFijh0i1Ce5CI8HRN2xIB3rxDI/s64/Ink_Regeneration.webp",
        desc: "增加上限與回復次數。",
      },
      濡墨滯行: {
        branch: 2,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiozoDD_ALqFFgOnDgOFW7yezJx564WHKpRQDnwPeVwphs0MbJH2NYkvVJeAJd6QpQk9uWLQjFrMgnMl0ifZjaLOykTpFSa9PQGayXjOXxzlVnSX7aqgWUMzvUSkad4Im1Q2bsUMTI0IDBqtcsjoP_lOZ6mp_w9KZE7q1p0eZrpQRrVcGuXBX9nsFAP7w8/s64/Pause_and_Turn.webp",
        desc: "清域敵人降傷與遲緩。",
      },
      水墨飄影: {
        branch: 2,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhaIHw-4-cB0k9Pf-Uh62B90r6-ucWZtst_v3RP5uUXhlwnU_yh7129S8_UqiFy_gBnEOf3P563NVs3AysQJIXE94hqz28HEI4WpXYgPX8b37tP3qSg9A-n0K58gU5AS2TD09YqtwNzjdjTYDpUnFt1ddb20NhLhNXK1wNxAUlSicGEzpjCzskabx2OwyI/s64/Quick_Sketch.webp",
        desc: "清域加速與移速增傷。",
      },
      //覺醒分支三
      墨影幽恒: {
        branch: 3,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjfxYOe4SNanvHs2m_tL93KAg6JzsPNWy81tVMmM59CxdlXiksxQCXEMx1dEEsCvthQR4GFp-32mxnGy0knYbAiDdxxq93e7nDuJenUy_TzTd9He4QgnmazxjgePmmC_UBxV-n6SUnH57YRVjCjh8p9ULHD9gDBXurtLsMwUcNcx1xEe6ugQ5b1MVMBnCQ/s64/Shade_Drawing.webp",
        desc: "強化墨影與武器技能。",
      },
      遠繪近染: {
        branch: 3,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEigwQ0PelbqF3uRGHtCGAm5tNv6P2pLu_3crU61RV5w6IVGI-9cU__AHo9XiSV6z-g_5yJ5VdbIG2buLM9O88wIaWOY0lGqMVddoGkk24WoouYqsJJO7NsrLysQNJTI6QZHMRBy4au8GOjKEH-nAjeCMhxfaNU4rCsUKc8C6x3aBpFYQUBnag5NdHWvJyQ/s64/Geometry_Art.webp",
        desc: "遠近增益與幸運加成。",
      },
      墨染凡塵: {
        branch: 3,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjTCDBMEd06zy3-zvpDhtRy12ulGJpf1FaJSymxnR3IlG9l9CwBNK1Nx_ytUNnOztMq2HeoEk0W6DRtg7j910jOk1Ey8EqS3IiCOO-gthi12Vtmr-L11nMUvukXuO2dBXLhNmThEMXnO0VStvqBn44Kt1L9Ll2AuEYTAYd5AvmNOz0F4mWFnNaLYwSxxBA/s64/Grinding_Ink.webp",
        desc: "技後增傷與回復資源。",
      },
      浴墨蝕心: {
        branch: 3,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiuC9xObUdf5VgIBgWqr5juLFxv8-pFEt8wRpevDAA5GnO2W2jybPRoLX9TXdCDlfgr80TXsri2Uol6LHcDXhuM9N3tcTgd9tDMYxNPfljppbn3OmZ7Rwz4WJq_hQjsN0h-7Ll_nnWsz91TKnndVdpy3Z_0qwhcHgdFYvRItkVM5iSP4mQ-tBYu8VN_0jI/s64/Leaving_Blank.webp",
        desc: "延長清域狀態並增傷。",
      },
      墨韻流影: {
        branch: 3,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg2Kbb2wW6edeIgNpokEgLjwk61NofKqXfLEl5h5ozyyoKVlh6gk9xGDvW_S1Y5MII5pWGhwVnaujJ-ADE82NyNp5LERt_ORr66SrT4XOUgSi9rqN59w5tqWr4XGFSPVcmOZualS65waW6YKHPgd_PwgYEQtjCmpydoYjvhtXi6GKK4BJC_krDxfZPJiLg/s64/Breathing_Rhythm.webp",
        desc: "增墨韻與化形生清域。",
      },
      栖墨生息: {
        branch: 3,
        img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi1Ml3CoWBCNzXT5KzNoPeSmYBU3ho-bimMGnMLN0io_cuPlYYXE0uUanFb4zpnM1tuMmwqmTdl5C6ZbBxRwvRZ_7s7CBRazZR6g3lEemmO53d8-6jzFiXRXP32N4Xz2hbpInwITqDN87jPRu2PyZAIDwm8YN2QmtVdf3mp-kPppaSI49UfwezxWwDcsuA/s64/Hold_Brush.webp",
        desc: "清域內增護盾與回盾。",
      },
    },
    blessings: {
